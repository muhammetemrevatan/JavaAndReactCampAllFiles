...
public class Main {
	...
	public static void main(String[] args) {
		...
		Sales sale2 = new Sales(2, 200, "Mound And Blade Warband 2");
		Campaign campaign1 = new Campaign(1, "yayýncý indirimi %10", 10);
		Campaign campaign2 = new Campaign(0, "normal satýn alým indirimi %0", 0);
		...
		campaignServiceManager.controlGameId(campaign2, sale2);
		salesManager.sale(sale2, customer2);
